...
function findWasmBinary() {
  return locateFile("mv2player.wasm");
}
...
var _extract_first_mv2_from_zip = Module["_extract_first_mv2_from_zip"] = makeInvalidEarlyAccess("_extract_first_mv2_from_zip");

var _mv2_create_from_memory = Module["_mv2_create_from_memory"] = makeInvalidEarlyAccess("_mv2_create_from_memory");

var _mv2_destroy = Module["_mv2_destroy"] = makeInvalidEarlyAccess("_mv2_destroy");

var _mv2_get_width = Module["_mv2_get_width"] = makeInvalidEarlyAccess("_mv2_get_width");

var _mv2_get_height = Module["_mv2_get_height"] = makeInvalidEarlyAccess("_mv2_get_height");

var _mv2_get_num_frames = Module["_mv2_get_num_frames"] = makeInvalidEarlyAccess("_mv2_get_num_frames");

var _mv2_get_fps = Module["_mv2_get_fps"] = makeInvalidEarlyAccess("_mv2_get_fps");

var _mv2_get_frame_rgba = Module["_mv2_get_frame_rgba"] = makeInvalidEarlyAccess("_mv2_get_frame_rgba");

var _mv2_free_buffer = Module["_mv2_free_buffer"] = makeInvalidEarlyAccess("_mv2_free_buffer");

var _mv2_get_audio_blob = Module["_mv2_get_audio_blob"] = makeInvalidEarlyAccess("_mv2_get_audio_blob");

var _mv2_create_from_path = Module["_mv2_create_from_path"] = makeInvalidEarlyAccess("_mv2_create_from_path");

var _mv2_write_audio_to_file = Module["_mv2_write_audio_to_file"] = makeInvalidEarlyAccess("_mv2_write_audio_to_file");

var _mv2_write_frame_png = Module["_mv2_write_frame_png"] = makeInvalidEarlyAccess("_mv2_write_frame_png");

var _wasm_alloc = Module["_wasm_alloc"] = makeInvalidEarlyAccess("_wasm_alloc");
...
function assignWasmExports(wasmExports) {
  ...
  assert(typeof wasmExports["extract_first_mv2_from_zip"] != "undefined", "missing Wasm export: extract_first_mv2_from_zip");
  assert(typeof wasmExports["mv2_create_from_memory"] != "undefined", "missing Wasm export: mv2_create_from_memory");
  assert(typeof wasmExports["mv2_destroy"] != "undefined", "missing Wasm export: mv2_destroy");
  assert(typeof wasmExports["mv2_get_width"] != "undefined", "missing Wasm export: mv2_get_width");
  assert(typeof wasmExports["mv2_get_height"] != "undefined", "missing Wasm export: mv2_get_height");
  assert(typeof wasmExports["mv2_get_num_frames"] != "undefined", "missing Wasm export: mv2_get_num_frames");
  assert(typeof wasmExports["mv2_get_fps"] != "undefined", "missing Wasm export: mv2_get_fps");
  assert(typeof wasmExports["mv2_get_frame_rgba"] != "undefined", "missing Wasm export: mv2_get_frame_rgba");
  assert(typeof wasmExports["mv2_free_buffer"] != "undefined", "missing Wasm export: mv2_free_buffer");
  assert(typeof wasmExports["mv2_get_audio_blob"] != "undefined", "missing Wasm export: mv2_get_audio_blob");
  assert(typeof wasmExports["mv2_create_from_path"] != "undefined", "missing Wasm export: mv2_create_from_path");
  assert(typeof wasmExports["mv2_write_audio_to_file"] != "undefined", "missing Wasm export: mv2_write_audio_to_file");
  assert(typeof wasmExports["mv2_write_frame_png"] != "undefined", "missing Wasm export: mv2_write_frame_png");
  assert(typeof wasmExports["wasm_alloc"] != "undefined", "missing Wasm export: wasm_alloc");
  ...
  _extract_first_mv2_from_zip = Module["_extract_first_mv2_from_zip"] = createExportWrapper("extract_first_mv2_from_zip", 4);
  _mv2_create_from_memory = Module["_mv2_create_from_memory"] = createExportWrapper("mv2_create_from_memory", 2);
  _mv2_destroy = Module["_mv2_destroy"] = createExportWrapper("mv2_destroy", 1);
  _mv2_get_width = Module["_mv2_get_width"] = createExportWrapper("mv2_get_width", 1);
  _mv2_get_height = Module["_mv2_get_height"] = createExportWrapper("mv2_get_height", 1);
  _mv2_get_num_frames = Module["_mv2_get_num_frames"] = createExportWrapper("mv2_get_num_frames", 1);
  _mv2_get_fps = Module["_mv2_get_fps"] = createExportWrapper("mv2_get_fps", 1);
  _mv2_get_frame_rgba = Module["_mv2_get_frame_rgba"] = createExportWrapper("mv2_get_frame_rgba", 2);
  _mv2_free_buffer = Module["_mv2_free_buffer"] = createExportWrapper("mv2_free_buffer", 1);
  _mv2_get_audio_blob = Module["_mv2_get_audio_blob"] = createExportWrapper("mv2_get_audio_blob", 3);
  _mv2_create_from_path = Module["_mv2_create_from_path"] = createExportWrapper("mv2_create_from_path", 1);
  _mv2_write_audio_to_file = Module["_mv2_write_audio_to_file"] = createExportWrapper("mv2_write_audio_to_file", 2);
  _mv2_write_frame_png = Module["_mv2_write_frame_png"] = createExportWrapper("mv2_write_frame_png", 3);
  _wasm_alloc = Module["_wasm_alloc"] = createExportWrapper("wasm_alloc", 1);
